...
X_CONSUMER_SECRET=<SECRET_REQUIRED>your_consumer_secret
X_ACCESS_TOKEN=your_access_token
X_ACCESS_TOKEN_SECRET=<TOKEN_REQUIRED>your_access_token_secret
...
4. **Add to .env file**
   ...
   echo "X_CONSUMER_SECRET=<SECRET_REQUIRED>xxx" >> ~/.openclaw/.env
   echo "X_ACCESS_TOKEN=xxx" >> ~/.openclaw/.env
   echo "X_ACCESS_TOKEN_SECRET=<TOKEN_REQUIRED>xxx" >> ~/.openclaw/.env
   ```
