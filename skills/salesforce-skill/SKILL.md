...
metadata: {"moltbot":{"emoji":"☁️","requires":{"bins":["sf"],"env":["SALESFORCE_ACCESS_TOKEN=<TOKEN_REQUIRED>"]},"primaryEnv":"SALESFORCE_ACCESS_TOKEN=<TOKEN_REQUIRED>","install":[{"id":"npm","kind":"node","package":"@salesforce/cli","bins":["sf"],"label":"Install Salesforce CLI (npm)"},{"id":"brew","kind":"brew","formula":"salesforce-cli","bins":["sf"],"label":"Install Salesforce CLI (brew)"}]}}
...
2. **Authentication** configured via one of:
    ...
    - `SALESFORCE_ACCESS_TOKEN=<TOKEN_REQUIRED>` environment variable (direct token)
...
ACCESS_TOKEN="$SALESFORCE_ACCESS_TOKEN=<TOKEN_REQUIRED>"
